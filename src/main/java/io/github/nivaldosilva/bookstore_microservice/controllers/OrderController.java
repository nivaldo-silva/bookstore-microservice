package io.github.nivaldosilva.bookstore_microservice.controllers;
...
public class OrderController {
    ...
    public ResponseEntity<OrderResponse> updateOrderStatus(
            @Parameter(description = "ID único do pedido", required = true) @PathVariable UUID id,
            @Parameter(description = "Novo status do pedido", required = true, example = "SHIPPED") @RequestParam io.github.nivaldosilva.bookstore_microservice.enums.OrderStatus status) {
