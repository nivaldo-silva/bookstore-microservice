...
### Microsserviço de Livraria

#### Visão Geral

Este projeto implementa um microsserviço completo para sistema de livraria online, desenvolvido com Spring Boot. A aplicação oferece funcionalidades abrangentes para cadastro e gerenciamento de livros, autores, clientes e pedidos, seguindo rigorosamente boas práticas de desenvolvimento, arquitetura limpa e princípios SOLID.
